...
DEFINE_string(video,                    "examples/media/20180509_194511.avi",             "Use a video file instead of the camera. Use `examples/media/video.avi` for our default"
                                                        " example video.");
...
DEFINE_string(write_video,              "examples/media_out/20180509_194511.avi",             "Full file path to write rendered frames in motion JPEG video format. It might fail if the"
...
DEFINE_string(write_keypoint_json,      "examples/media_out",             "(Deprecated, use `write_json`) Directory to write people pose data in JSON format,"
